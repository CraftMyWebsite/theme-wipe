...
return [
   /* - - - - - - - - 
    ...
    "faq_display_autor" => "true",
    "faq_display_form" => "true",
    ...
    "wiki_display_categorie_icon" => "true",
    "wiki_display_article_categorie_icon" => "true",
    "wiki_display_article_icon" => "true",
