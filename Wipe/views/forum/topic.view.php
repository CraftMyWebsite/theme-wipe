            ...
            <div class="lg:grid grid-cols-5">
                ...
                <div class="col-span-4 py-4 pr-2">
                    ...
                    <div class="flex justify-end p-1">
                        ...
                        <i data-modal-target="popup-modal" data-modal-toggle="popup-modal" data-tooltip-target="tooltip-delete" class="fa-solid fa-trash text-red-500 ml-4"></i>
                            ...
                            <div class="relative w-full h-full max-w-md md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        ...
                                        <a href="<?= $response->deleteLink() ?>" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                            Supprimer
                                        </a>
