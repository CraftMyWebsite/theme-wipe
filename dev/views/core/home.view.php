        ...
        <div class="flex flex-wrap -mx-4  justify-center">
            <div class="p-4 w-full md:w-6/12 lg:w-4/12">
                <div class="bg-gray-100 p-4">
                    <!--PROD DEFINIR LA SOURCE-->
                    <img src="/dev/img/bread.webp" class="mb-3 mx-auto" alt="Vous devez upload bread.webp depuis votre panel !" width="160" height="160"/>
                    <div>
            ...
            <div class="p-4 w-full md:w-6/12 lg:w-4/12">
                <div class="bg-gray-100 p-4">
                    <!--PROD DEFINIR LA SOURCE-->
                    <img src="/dev/img/potion.webp" class="mb-3 mx-auto" alt="Vous devez upload potion.webp depuis votre panel !" width="160" height="160">
                    <div>
            ...
            <div class="p-4 w-full md:w-6/12 lg:w-4/12">
                <div class="bg-gray-100 p-4">
                    <!--PROD DEFINIR LA SOURCE-->
                    <img src="/dev/img/craftingtable.webp" class="mb-3 mx-auto" alt="Vous devez upload craftingtable.webp depuis votre panel !" width="160" height="160">
                    <div>
...
<section class="py-8">
    <div class="flex flex-no-wrap justify-center items-center py-4">
        <div class="bg-gray-500 flex-grow h-px max-w-sm"></div>
        <div class="px-10 w-auto">
            <h2 class="font-semibold text-2xl uppercase">Nous contacter</h2>
        </div>
        <div class="bg-gray-500 flex-grow h-px max-w-sm"></div>
    </div>
    <div class="container mx-auto px-4 xl:px-72">
        <form class="rounded-md shadow-lg p-8">
