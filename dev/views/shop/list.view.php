...
<section class="bg-white rounded-lg shadow my-8 sm:mx-12 lg:mx-72">
    <div class="container p-4">
        ...
        <div class="flex flex-wrap justify-between border-t border-b py-2">
            ...
            <div>
                <a href="#" class="inline-flex relative items-center p-3 text-sm font-medium text-center text-black hover:text-blue-600">
                    <i class="text-xl fa-solid fa-cart-shopping"></i>
                    <span class="sr-only">Articles</span>
                    <div class="inline-flex  absolute -top-2 -right-2 justify-center items-center w-6 h-6 text-xs font-bold text-white bg-red-500 rounded-full border-2 border-white dark:border-gray-900">4</div>
                </a>
            </div>
