    ...
    <div class="container p-4">
        <div class="xl:grid grid-cols-6 gap-6">
            <div class="col-span-2 h-fit">
                <img class="rounded-lg w-full" src="https://i.notretemps.com/2000x1125/smart/2022/10/07/pains.jpg" alt="Article">
            </div>
            <div class="col-span-4 h-fit">
                <h2 class="font-medium">Du pain !</h2>
                ...
                <h3>15,50 €</h3>
                <p>Ceci est une description courte de l'article !</p>
                <form class="flex items-center my-2">
                    <input type="number" value="1" id="quantity" class="text-center w-14 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                ...
                <p>Catégorie : <a href="#" class="text-blue-600 hover:text-blue-400">Pain</a></p>
            </div>
        </div>
